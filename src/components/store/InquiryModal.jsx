...
export default function InquiryModal({ product, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    const selectedSource = source === 'Other' ? `Other: ${otherSource}` : source;
    ...
    try {
      // POST the lead data to the backend /leads endpoint
      ...
      toast.error('Unable to record inquiry lead. Proceeding to WhatsApp anyway...');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b border-gold/15 bg-dark-base">
          <h3 className="font-serif text-lg text-gold tracking-wide font-medium">Inquire About This Product</h3>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-4 p-3 bg-dark-base/50 border border-gold/10 rounded-lg">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="text-sm font-medium font-serif tracking-wide text-white">{product.name}</h4>
          ...
          <div className="flex gap-2.5 p-3.5 bg-gold/5 border border-gold/20 rounded-lg text-xs leading-relaxed text-gold/90 font-light">
            ...
            <p>
              <strong>Notice:</strong> Submitting this form registers your interest on our portal, and you will be automatically redirected to WhatsApp to complete your message with our sales representatives.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="inquiry-name" className="block text-xs uppercase tracking-widest text-warm-ivory/60 mb-1.5 font-medium">
            ...
            <div>
              <label htmlFor="inquiry-phone" className="block text-xs uppercase tracking-widest text-warm-ivory/60 mb-1.5 font-medium">
            ...
            <div>
              <label htmlFor="inquiry-source" className="block text-xs uppercase tracking-widest text-warm-ivory/60 mb-1.5 font-medium">
              ...
              >
                ...
                <option value="Exhibition/Banner">Exhibition or Banner Ad</option>
            ...
            {source === 'Other' && (
              <div className="animate-fade-in">
                <label htmlFor="inquiry-other" className="block text-xs uppercase tracking-widest text-warm-ivory/60 mb-1.5 font-medium">
