...
const BIBLE_VERSES = [
  ...
  { text: "Have I not commanded you? Be strong and courageous. Do not be frightened, for the Lord your God is with you.", ref: "Joshua 1:9" },
  ...
  return (
    <footer className="bg-dark-charcoal border-t border-gold/20 text-warm-ivory/80 pt-16 pb-8 px-6 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-4">
          <Link to="/" className="inline-block">
            ...
            <span className="block text-xs uppercase tracking-[0.25em] text-white/50">SUPPLIERS</span>
          </Link>
          <p className="text-sm font-light text-warm-ivory/60 leading-relaxed">
            Curators of premium products and elegant supplies. We offer a bespoke boutique experience tailored for those who appreciate fine quality, timeless craftsmanship, and exceptional customer service.
          </p>
        </div>

        {/* Quick links */}
        <div>
          <h4 className="font-serif text-lg font-medium text-white mb-6 tracking-wide border-b border-gold/10 pb-2">Quick Navigation</h4>
          <ul className="space-y-3 text-sm font-light">
            <li>
              <Link to="/" className="hover:text-gold transition-colors duration-300">Home</Link>
            </li>
            <li>
              <Link to="/shop" className="hover:text-gold transition-colors duration-300">Browse Collection</Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-gold transition-colors duration-300">Our Story</Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-gold transition-colors duration-300">Inquire & Contact</Link>
            </li>
            <li>
              <Link to="/admin/login" className="hover:text-gold transition-colors duration-300 text-gold/60">Staff Portal</Link>
            </li>
          </ul>
        </div>
        ...
        {/* Contact info */}
        <div>
          <h4 className="font-serif text-lg font-medium text-white mb-6 tracking-wide border-b border-gold/10 pb-2">Connect With Us</h4>
          <ul className="space-y-4 text-sm font-light">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+254700000000" className="hover:text-gold transition-colors duration-300 text-warm-ivory/60">
                +254 700 000 000
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={16} className="text-gold shrink-0" />
              <a href="mailto:info@salmaxsuppliers.com" className="hover:text-gold transition-colors duration-300 text-warm-ivory/60">
        ...
        {/* Social presence */}
        <div>
          <h4 className="font-serif text-lg font-medium text-white mb-6 tracking-wide border-b border-gold/10 pb-2">Socials</h4>
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center hover:border-gold hover:text-gold transition duration-300 text-warm-ivory/70" aria-label="Instagram">
            ...
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center hover:border-gold hover:text-gold transition duration-300 text-warm-ivory/70" aria-label="Facebook">
      ...
      <div className="max-w-7xl mx-auto border-t border-gold/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs font-light text-warm-ivory/40 gap-4">
        <div>
          &copy; {new Date().getFullYear()} Salmax Suppliers. All rights reserved.
        </div>
        <div className="flex gap-6">
          <Link to="/about" className="hover:text-gold transition-colors duration-300">Privacy Policy</Link>
          <Link to="/contact" className="hover:text-gold transition-colors duration-300">Terms of Service</Link>
        </div>
      </div>
    </footer>
  );
