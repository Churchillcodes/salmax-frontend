...
export default function Home() {
  ...
  return (
    <div className="bg-dark-base min-h-screen text-warm-ivory">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
        <div className="space-y-6">
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-light text-white tracking-wide leading-tight">
            Curators of Premium <br />
            Boutique Essentials
          </h2>
          <p className="text-warm-ivory/70 font-light leading-relaxed">
            At Salmax Suppliers, we believe that elegance lies in the details.
            We catalog only the finest fabrics, boutique collectibles, and
            premium products, serving as a trusted supplier for discerning
            clientele.
          </p>
          <p className="text-warm-ivory/70 font-light leading-relaxed">
            Every product in our boutique catalogue undergoes rigorous
            assessment for design integrity, quality, and functionality. We take
            pride in bridging high-fashion aesthetics with seamless purchase
            processes.
          </p>
          <div className="pt-4">
            <RouterLink
      ...
      <section className="py-16 sm:py-20 bg-dark-charcoal/30 border-y border-gold/5">
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse bg-dark-charcoal border border-gold/5 rounded-xl aspect-[3/4]"
                />
              ))}
            </div>
            ...
            <div className="text-center py-16 border border-dashed border-gold/10 rounded-xl bg-dark-base/40">
              ...
              <p className="font-serif italic text-warm-ivory/60 text-lg mb-1">
                Catalogue is currently being curated
              </p>
              <p className="text-xs text-warm-ivory/40">
                Check back shortly to discover new arrivals.
              </p>
            </div>
          )}
        </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-dark-charcoal border border-gold/10 p-8 rounded-xl space-y-4 hover:border-gold/30 premium-transition">
            ...
            <p className="text-warm-ivory/60 text-sm font-light leading-relaxed">
              No compromises. We source directly from trusted manufacturers and
              perform rigorous quality audits on all items before delivery.
            </p>
          </div>
          ...
          <div className="bg-dark-charcoal border border-gold/10 p-8 rounded-xl space-y-4 hover:border-gold/30 premium-transition">
            ...
            <p className="text-warm-ivory/60 text-sm font-light leading-relaxed">
              ...
              post-purchase followups, we support client requests personally.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-dark-charcoal/20 border-t border-gold/5 text-center">
        <div className="max-w-4xl mx-auto px-6 space-y-8">
          ...
          <p className="font-serif text-2xl md:text-3xl italic text-white/95 leading-relaxed font-light">
            "The customer service was absolutely spectacular. They handled my
            apparel inquiry on WhatsApp within minutes and made sure delivery to
            my office was seamless. Highly recommend Salmax."
          </p>
          <div className="space-y-1">
            <p className="text-sm font-semibold tracking-wider uppercase text-gold">
              Victoria N. W.
            </p>
            <p className="text-xs text-warm-ivory/40 uppercase tracking-widest">
              Bespoke Buyer
            </p>
          </div>
        </div>
