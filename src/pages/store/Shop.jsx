...
import { normalizeCategory, normalizeProduct } from "../../utils/apiData";
...
export default function Shop() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesGroup =
      selectedGroup === "All" || productGroup === selectedGroup;
  ...
  return (
    <div className="bg-dark-base min-h-screen text-warm-ivory py-8 sm:py-12 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Page Header */}
        <div className="text-center max-w-2xl mx-auto mb-8 space-y-3 sm:mb-12">
          ...
          <p className="text-warm-ivory/60 text-sm font-light leading-relaxed">
            Browse through our portfolio of clothing, premium accessories, and
            boutique materials. Inquire directly on WhatsApp to order.
          </p>
        </div>

        {/* Toolbar: Search and Filter Toggles */}
        <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center mb-8 bg-dark-charcoal/40 p-3 sm:p-4 border border-gold/10 rounded-xl">
          {/* Search bar */}
          <div className="relative w-full md:w-80">
            <Search
              className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gold/45"
              size={16}
            />
            <input
              type="text"
          ...
          <div className="flex items-center justify-between w-full md:w-auto gap-4">
            <button
              ...
              className="lg:hidden flex w-full items-center justify-center gap-2 bg-dark-base border border-gold/10 px-4 py-2.5 rounded-lg text-sm hover:border-gold text-gold/80 sm:w-auto"
            >
        ...
        {showMobileFilters && (
          <div className="lg:hidden bg-dark-charcoal/60 border border-gold/10 rounded-xl p-5 mb-6 space-y-4 animate-fade-in">
            <div className="flex justify-between items-center border-b border-gold/10 pb-3">
              <h3 className="font-serif text-sm text-gold tracking-wide">
                Filter Catalogue
              </h3>
              <button
        ...
        {loading ? (
          ...
          <div className="text-center py-24 border border-dashed border-gold/10 rounded-xl bg-dark-charcoal/20">
            ...
            <h3 className="font-serif italic text-lg text-warm-ivory/80 mb-2">
              No Matching Products Found
            </h3>
            <p className="text-xs text-warm-ivory/40 max-w-sm mx-auto leading-relaxed">
              We couldn't find any products in our current boutique inventory
              matching your search query or filter criteria.
            </p>
            <button
              onClick={clearFilters}
